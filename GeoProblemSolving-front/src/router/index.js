...
const routes = [{
  path: '/', name: 'Navigation', component: resolve => (require(["@/components/navigation"], resolve)), children: [
    ...
    { path: 'project/:subid/workspace/contextdefinition/:id', name: 'contextDefinition', component: resolve => (require(["@/components/workingSpace/contextDefinition"], resolve)) },
...
{ path: '/par', name: 'chatUtil2', component: resolve=>(require(["@/components/workingSpace/onlineParticipants"],resolve)) },
