<template>
  <div style="display: flex; background-color: #eee">
    ...
    <Card dis-hover class="workspaceCard" id="ActivityContent">
      ...
      <div slot="extra">
        <!-- <Button v-if="slctActivity.level > 0 || (slctActivity.level == 0 && slctActivity.type != 'Activity_Default')"
          icon="md-create"
          size="small"
        ...
        >Edit</Button>
        <Button v-if="slctActivity.level > 0"
          icon="md-trash"
          size="small"
    ...
    >
      ...
      >
        ...
        <FormItem label="Description" prop="description" v-if="slctActivity.level!=0">
          <Input
...
<script>
  ...
  import {roleIdentify} from "./../../api/userRole";
