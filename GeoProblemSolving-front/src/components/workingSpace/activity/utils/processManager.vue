...
<!--            </div>-->
          ...
          <div v-if="collaborating">
            <div v-for="(item, index) in collaboratingInfoList" style="margin-bottom: 10px; background-color: pink;">
              <avatar-list
                v-if="item.collLinkUser.length > 0"
                :list="item.collLinkUser"
                :key="index"
                @click.native="joinLinkCollaboration(index)"
                style="cursor:pointer;"></avatar-list>
            </div>
          </div>
        </Row>
    ...
    >
      <div slot="footer">
        <div style="display: inline-block; position: absolute;left: 10px">
          <avatar-list :list="collLinkUser" v-if="collLinkUser.length > 1"></avatar-list>
        </div>
      ...
      <div style="margin: 0 20px">
        ...
        <template v-if="userProtocolForm.roleProtocol === 'Constraints'">
          ...
          <div style="display: flex">
            ...
            <Select v-model="userProtocolForm.selectUserDomain"
                    multiple :max-tag-count="4"
          ...
          <div style="display: flex">
            ...
            <Select v-model="userProtocolForm.selectUserOrg"
                    multiple :max-tag-count="4"
      ...
      <div style="margin: 0 20px">
        <div style="display: flex; margin-bottom: 15px">
          ...
          <i-switch v-model="resProtocolForm.autoUpdate" @on-change="autoUpdateChange"/>
        </div>
        <div style="display: flex; margin-bottom: 15px">
          <div style="margin-top: 5px; width: 150px">
    ...
    watch: {
      ...
      linkBuildModal() {
        if (this.linkBuildModal) {
          this.linkingId = this.selectedActivities.map(item => {
            return item.aid
          }).toString();
          return;
        }
    ...
    methods: {
      computeCollIndex(collLinkId) {
        ...
        for (let i = 0; i < this.collaboratingId.length; i++) {
          if (collLinkIdArr.every(item =>
            this.collaboratingId[i].includes(item)
          )) {
            this.collaIndex =  i;
            return;
          }
      ...
      socketOnMessage: function (messageJson) {
        ...
        if (type == "general") {
          ...
          if (behavior == "inActivities") {
            this.$Notice.info({title: `${senderName}  join the page of pathway.`});
            ...
            if (this.linkingId == content.linkingId){
              //todo: 测试是否正确
              this.collLinkUser = this.collLinkUser.filter(item=> item.userId != tempUserId);
            }else {
            ...
            if (this.linkingId == content.linkingId){
              ...
              this.collaboratingInfoList[this.collaIndex].collLinkUser = tempCollLinker;
            }
            ...
            switch (param) {
              case "protocolType":
                ...
                if (this.linkingId == collLinkId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].protocolType = tempType;
                  this.collaboratingInfoList[this.collaIndex].selectedActivities = tempSel;
                  this.collaboratingInfoList[this.collaIndex].otherNodes = JSON.parse(JSON.stringify(tempSel));
              ...
              case "activityLinks":
                ...
                if (this.linkingId == content.linkingId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].activityLinks = tempLinks;
                  this.collaboratingInfoList[this.collaIndex].otherNodes = tempOtherNodes;
                }
                break;
              case "roleProtocol":
                ...
                if (this.linkingId == content.linkingId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].userProtocolForm.roleProtocol = tempRole;
                  if (tempRole == "Constraints"){
                    this.collaboratingInfoList[this.collaIndex].userDomains = content.userDomain;
                    this.collaboratingInfoList[this.collaIndex].userOrganizations = content.userOrganizations;
                  }
                }
                break;
              case "userRole":
                ...
                if (this.linkingId == content.linkingId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].userProtocolForm.linkRoles = tempRoles;
                }
                break;
              case "userDomain":
                let tempSelectDomain = content.selectUserDomain;
                if (this.linkingId == content.linkingId) {
                  this.$set(this.userProtocolForm, "selectUserDomain", tempSelectDomain);
                } else {
                  this.computeCollIndex(content.linkingId);
                  if (this.collaIndex == -1) {
                    return;
                  }
                  this.collaboratingInfoList[this.collaIndex].userProtocolForm.selectUserDomain = tempSelectDomain;
                }
                break;
              case "userOrganization":
                let tempSelectOrg = content.userSelectOrganization;
                if (this.linkingId == content.linkingId) {
                  this.$set(this.userProtocolForm, "selectUserOrg", tempSelectOrg);
                } else {
                  this.computeCollIndex(content.linkingId);
                  if (this.collaIndex == -1) {
                    return;
                  }
                  this.collaboratingInfoList[this.collaIndex].userProtocolForm.selectUserOrg = tempOrg;
                }
                break;
              case "autoUpdate":
                ...
                if (this.linkingId == content.linkingId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].resProtocolForm.autoUpdate = tempAuto;
                }
                break;
              case "resProtocol":
                ...
                if (this.linkingId == content.linkingId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].resProtocolForm.resProtocol = tempProtocol;
                }
                break;
              case "resType":
                ...
                if (this.linkingId == content.linkingId) {
                  ...
                  this.collaboratingInfoList[this.collaIndex].resProtocolForm.types = tempTypes;
                }
                break;
                case "resFormat":
                  ...
                  if (this.linkingId == content.linkingId) {
                    ...
                    this.collaboratingInfoList[this.collaIndex].resProtocolForm.formats = tempFormat;
                  }
                  break;
                  case "resScale":
                    ...
                    if (this.linkingId == content.linkingId) {
                      ...
                      this.collaboratingInfoList[this.collaIndex].resProtocolForm.scales = tempScale;
                    }
                    break;
                    case "resReference":
                      ...
                      if (this.linkingId == content.linkingId) {
                        ...
                        this.collaboratingInfoList[this.collaIndex].resProtocolForm.references = tempReference;
                      }
                      break;
                      case "resUnit":
                        ...
                        if (this.linkingId == content.linkingId) {
                          ...
                          this.collaboratingInfoList[this.collaIndex].resProtocolForm.units = tempUnit;
                        }
                        break;
                        case "resConcept":
                          ...
                          if (this.linkingId == content.linkingId) {
                            ...
                            this.collaboratingInfoList[this.collaIndex].resProtocolForm.concepts = tempConcept;
                          }
                          break;
            }
          }
      ...
      joinLinkCollaboration(index) {
        ...
        this.linkingId = this.selectedActivities.map(item=> {return item.aid}).toString();
        ...
        let joiner = this.participants.filter(item =>  item.userId == this.userInfo.userId);
            ...
            if (this.collaIndex == -1){
              ...
              let content = {
                ...
                linkInfo: {
                  ...
                  collLinkUser: this.participants.filter(item=> item.userId == this.userInfo.userId)
                }
              };
              this.sendLinkSock(content);
            }else {
          ...
          this.axios
            ...
            .then((res) => {
              ...
              if (code != 0) {
                ...
                this.userDomain = data.domains.map(item=>{return {name: item}});
                this.userOrganizations = data.organizations.map(item=>{return {name: item}});
