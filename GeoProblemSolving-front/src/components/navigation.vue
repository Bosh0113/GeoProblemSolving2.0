  ...
  <div class="container">
    <div style="position: fixed;z-index: 999;">
      <header style="position:inherit;min-width: -webkit-fill-available;">
        <img src="@/assets/images/OGMS.png" id="logo" class="pic" @click="goHome" style="cursor:pointer;margin-left:5%">
        <div v-if="useMenuCSS">
          <div class="navPart">
            <Menu mode="horizontal" theme="dark" active-name="home" @on-select="turnContent"
              :style="`z-index:0;background:`+headerBgColor" width="auto">
          ...
          <div class="userState">
            <Menu mode="horizontal" theme="dark" @on-select="unlogin" :style="`z-index:0;background:`+headerBgColor"
              v-show="!userState" class="menuItem">
              <MenuItem name="login">
              <span>Login</span>
              </MenuItem>
            ...
            <Menu mode="horizontal" theme="dark" @on-select="logged" :style="`z-index:0;background:`+headerBgColor"
              v-show="userState" class="menuItem">
              ...
              <Dropdown @on-click="changeSelect" placement="bottom-start">
                <div @click="toPersonalPage">
                  <img v-bind:src="avatar" v-if="avatar!=''&&avatar!=undefined&&avatar!=null" :title="userName"
