      ...
      <Col span="18" offset="3" :style="{height:contentHeight}">
        <div style="display:flex;justify-content:center;margin-top:100px;height:100%;padding:100px">
          <Form :label-width="120">
            ...
            <br />
            <div
              v-show="registeredHintShow==true"
              style="margin-left:120px;display:flex;align-items:center;width:600px"
            >
              <Icon type="ios-information-circle-outline" :size="30" color="yellowGreen" />
              <span style="font-size:10px;">
                {{this.registeredHint}}
                <br />Now you need to fill the password in the blank and then click the
                <strong style="font-weight:bold;color:blue">Join</strong> button later you will be a member of the project.
              </span>
            </div>
            <div
              v-show="unregisteredHintShow==true"
              style="margin-left:120px;display:flex;align-items:center;width:600px"
            >
              <Icon type="ios-information-circle-outline" :size="30" color="red" />
              <span style="font-size:10px;">
                {{this.unregisteredHint}}
                <br />If you input your own password here and press
                <strong style="font-weight:bold;color:blue">Sign up and Join</strong> button, your own account would be created based on the email presented above and you will join the project at the same time.
              </span>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      registeredHint:
        "This email has been registered,you have been a member in our platform.",
      ...
      unregisteredHint:
        "It seems that this email is not a registed user in our platform.",
      unregisteredOperate:
        "If you input your own password here and press Submit button,your own account would be created based on the email presented above and you will join the project at the same time.",
      // navaigation页面的变量
      //消息机制
      noticeSocket: null,
      unreadNoticeCount: 0,
  ...
  methods: {
    getProjectName() {
      this.axios
        .get(
          "/GeoProblemSolving/project/inquiry?key=projectId&&value=" +
    ...
    judgeMailRegister() {
      this.axios
        .get("/GeoProblemSolving/user/isRegistered?" + "email=" + this.email)
        .then(res => {
          if (res.data === true) {
            ...
            this.$Message.info(
              "you have use your email to register an account"
            );
            this.passwordInputShow = true;
          }
        })
      ...
      this.axios
        ...
        .then(res => {
          ...
          if (res.data === "Success") {
            ...
            this.$Message.info(
              "you have been in this group,no need to apply again"
            );
            this.autoLogin(this.email, passwordMD5, gotoProjectId);
        ...
        .then(res => {
          if (res.data === "Email") {
            ...
            window.location.href =
              "/GeoProblemSolving/projectDetail/" + projectId;
          }
        });
    }
  }
