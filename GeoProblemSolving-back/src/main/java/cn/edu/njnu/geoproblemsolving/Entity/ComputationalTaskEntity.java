...
@Document(collection = "ComputationalTask")
public class ComputationalTaskEntity {
    private String taskId;
    private String taskName;
    private String description;
    private String graphXML;
    private String logicalXML;
    private String computationalXML;
    private String collaborativeId;
    private String createTime;

    public String getComputationalXML() {
        return computationalXML;
    }
    ...
    public void setComputationalXML(String computationalXML) {
        this.computationalXML = computationalXML;
    }
}
