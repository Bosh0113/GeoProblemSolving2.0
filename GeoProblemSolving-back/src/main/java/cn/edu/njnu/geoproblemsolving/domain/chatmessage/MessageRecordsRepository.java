...
//    List<MessageRecords> findAllByRoomIdAndCreateTime(String roomId, String createTime, PageRequest pageRequest);
    ...
    List<MessageRecords> findByContentContainingAndRoomId(String key,String roomId, PageRequest pageRequest);
    List<MessageRecords> findByCreateTimeBetweenAndRoomId(Date from, Date to,String roomId, PageRequest pageRequest);
}
