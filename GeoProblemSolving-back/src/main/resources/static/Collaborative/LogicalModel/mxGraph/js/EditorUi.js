...
EditorUi.prototype.createFooter = function()
{
	...
	release.onclick=function () { demoRelease() };
	footer.appendChild(release);
	var requireList=document.createElement('span');
    requireList.id="waiting";
    requireList.innerHTML="Waiting: ";
    requireList.style.display="none";
    requireList.style.marginLeft="5%";
    var waitingNum=document.createElement('span');
    waitingNum.id="waitingNum";
    waitingNum.style.display="none";
	footer.appendChild(requireList);
    footer.appendChild(waitingNum);

    var require=document.createElement('button');
    require.innerHTML="Require";
    require.id="require";
    require.onclick=function () { demoRequire()  };
    footer.appendChild(require);
	return footer;
};
