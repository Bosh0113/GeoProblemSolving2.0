...
window.EXPORT_URL = window.EXPORT_URL || 'mxGraph/export';
window.SAVE_URL = window.SAVE_URL || 'mxGraph/save';
window.OPEN_URL = window.OPEN_URL || 'mxGraph/open';
...
window.OPEN_FORM = window.OPEN_FORM || 'mxGraph/open.html';
...
window.mxBasePath = window.mxBasePath || 'mxGraph/js/mxgraph';
