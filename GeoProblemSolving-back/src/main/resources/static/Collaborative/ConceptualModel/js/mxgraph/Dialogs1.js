 ...
 */
var tempNameId = "SRMUO12E4JFMIHZCBTI50JUHDX32Z7YG",firstPage = true;
var modelItemClassId = "5NXH51TKJISX2200IFDLI6VCJXFXNH";
var conceptClassId = "13b822a2-fecd-4af7-aeb8-0503244abe8f";
 ...
 */
var AddIconDialog = function(editorUi)
{
    var div = document.createElement('div');
    div.style.textAlign = 'right';
    var flexDiv1= document.createElement("div");
    flexDiv1.style.display = "inline-flex";
    flexDiv1.style.width = "100%";
    flexDiv1.style.marginBottom = "5px";
    div.appendChild(flexDiv1);
    var select = document.createElement("select");
    select.id = "iconParentSelect";
    select.style.width = "45%";
    flexDiv1.appendChild(select);

    var pdiv = document.createElement("div");
    pdiv.style.width = "45%";
    pdiv.style.marginLeft = "10%";
    pdiv.style.textAlign = "right";
    flexDiv1.appendChild(pdiv);
    var p = document.createElement("p");
    p.innerHTML = "you can create your own icon <a href='/GeoModelingNew/En/building/geoIconEditor.html'>click</a>";
    pdiv.appendChild(p);


    var flexDiv2= document.createElement("div");
    flexDiv2.style.display = "inline-flex";
    flexDiv2.style.width = "100%";
    flexDiv2.style.marginBottom = "5px";
    div.appendChild(flexDiv2);

    var infoTableDiv = document.createElement("div");
    infoTableDiv.id = "infoTable";
    infoTableDiv.style.width = "65%";
    infoTableDiv.style.height = "340px";
    infoTableDiv.style.maxHeight = "340px";
    infoTableDiv.style.overflowY = "hidden";
    infoTableDiv.style.border = "1px solid #e8e8e8";
    infoTableDiv.style.textAlign = "left";
    infoTableDiv.setAttribute("index",0);
    flexDiv2.appendChild(infoTableDiv);

    var ulDiv = document.createElement("div");
    ulDiv.style.width = "34%";
    ulDiv.id = "iconUl";
    ulDiv.style.textAlign = "left";
    ulDiv.style.height = "340px";
    ulDiv.style.maxHeight = "340px";
    ulDiv.style.marginLeft = "1%";
    flexDiv2.appendChild(ulDiv);

    var titleDiv = document.createElement("div");
    titleDiv.style.backgroundColor = "#e8e8e8";
    titleDiv.style.textAlign = "center";
    var h3 = document.createElement("h3");
    h3.innerHTML = "Select Icon List";
    h3.style.margin = "0px";
    h3.style.padding= "5px";
    titleDiv.appendChild(h3);
    ulDiv.appendChild(titleDiv);

    var listDiv = document.createElement("div");
    listDiv.id = "selectImgDiv";
    listDiv.style.textAlign = "center";
    listDiv.style.height = "300px";
    listDiv.style.maxHeight = "300px";
    listDiv.style.overflowY = "scroll";
    listDiv.style.border = "1px solid #e8e8e8";
    listDiv.style.padding = "2px";

    for (var i=0; i<9; i++){
        var temp_container = editorUi.sidebar.getIconClassificationContainer(i);
        var temp_count = temp_container.childElementCount;
        for (var icon=0; icon<temp_count; icon++){
            var temp_item = temp_container.childNodes[icon];
            var temp_uid = temp_item.getAttribute("icon_uid");
			var uid = temp_uid.substring(temp_uid.indexOf("=")+1);
            var innerDiv = document.createElement("div");
            innerDiv.className = "col-sm-3";
            innerDiv.style.position = "relative";
            innerDiv.style.width = "48px";
            innerDiv.style.height = "48px";
            innerDiv.style.padding = "0px";
            innerDiv.style.margin = "1px";
            innerDiv.style.border = "1px solid #d8d8d8";
            ...
            span.className = "glyphicon glyphicon-remove removeIcon";
    ...
    pageDiv.style.textAlign = "left";

    var ul = document.createElement("ul");
    ul.className = "page";
    ul.id = "addIconPage";
    ul.setAttribute("maxshowpageitem","5");
    ul.setAttribute("pagelistcount","12");
    ...
    {
    	$.ajax({
            url:"/GeoModelingNew/getIconRelationServlet",
            type:"get",
			success:function (result) {
                ...
                $.ajax({
                    url:"/GeoModelingNew/geoIconListServlet",
                    type:"get",
                    ...
                    success:function (data) {
                        ...
                        if(result.count===0){
                            $("#infoTable").empty();
                            if(language==="en"){
                                $("#infoTable").append("<p>There is no geographic icons in this classification</p>");
                            }else {
                                $("#infoTable").append("<p>该分类下没有地理图标</p>");
                            }
                            $("#addIconPage").empty();
                        }else {
                            $("#addIconPage").initPage(result.count,1,regetIcon);
    	...
    	$(document).off("change","#iconParentSelect");
        $(document).on('change','#iconParentSelect',function(){
            firstPageFlag = true;
            var nameId=$(this).val();
        ...
        $(document).off("click","#infoTable img");
        $(document).on("click","#infoTable img",function () {
        	var imgs = $("#selectImgDiv .col-sm-3 img");
        	for(var i=0;i<imgs.length;i++){
				if($(this)[0].id ===imgs.eq(i).attr("uid")){
					alert("The icon has been selected");
					return;
				}
			}
            var innerDiv = document.createElement("div");
            ...
            var img = document.createElement("img");
            img.setAttribute("uid",$(this)[0].id);
            img.setAttribute("index",$("#iconParentSelect")[0].selectedIndex);
            img.src = $(this)[0].src;
            img.width = 48;
            img.height =48;
    ...
    var okBtn = mxUtils.button(mxResources.get('ok'), function()
    {
        ...
        editorUi.sidebar.clearIconList();
        var imgs = $("#selectImgDiv .col-sm-3 img");
		for(var i=0;i<imgs.length;i++){
            editorUi.sidebar.addCustomImage(imgs.eq(i).attr("src"),imgs.eq(i).attr("index"));
		}
        editorUi.hideDialog();
    });
 ...
 * Constructs a new edit file dialog.
 */
var OpenTaskDialog = function (editorUi) {
    var div = document.createElement("div");
	div.style.textAlign = "right";
    ...
    curli.className = "cur";
    curli.innerHTML = "Online Task";
    var li  = document.createElement("li");
    li.innerHTML = "Upload Task";
    ul.appendChild(curli);
    ul.appendChild(li);
    tabList.appendChild(ul);

	var tabCon = document.createElement("div");
    tabCon.className = "tabCon";
    div.appendChild(tabCon);
	var Con1 = document.createElement("div");
	Con1.className = "cur";
    tabCon.appendChild(Con1);

    var Con1ChildDiv = document.createElement("div");
    Con1ChildDiv.style.display = "inline-flex";
    Con1ChildDiv.style.width = "100%";
    Con1.appendChild(Con1ChildDiv);

    var leftDiv = document.createElement("div");
    leftDiv.style.width = "35%";
    Con1ChildDiv.appendChild(leftDiv);

    var titleDiv = document.createElement("div");
    titleDiv.style.backgroundColor = "#e8e8e8";
    titleDiv.style.textAlign = "center";
    var h3 = document.createElement("h3");
    h3.innerHTML = "Task List";
    ...
    listDiv.id = "taskList";
    listDiv.style.textAlign = "center";
    listDiv.style.height = "309px";
    listDiv.style.maxHeight = "309px";
    ...
    var geoIcon = editorUi.sidebar.getAllLoadedIcon();
	textarea.value = geoIcon.outerHTML;
    Con1ChildDiv.appendChild(textarea);
    ...
    ul.id = "TaskPage";
    ul.setAttribute("maxshowpageitem","5");
    ul.setAttribute("pagelistcount","10");
    pageDiv.appendChild(ul);

    Con1.appendChild(pageDiv);

    var Con2 = document.createElement("div");
    Con2.style.width = "100%";
    Con2.style.height = "400px";
    tabCon.appendChild(Con2);
    ...
    Con2.appendChild(fileDiv);
    var fileNameInput = document.createElement("input");
    fileNameInput.style.width = "80%";
    fileNameInput.style.textIndent = "10px";
    fileNameInput.type = "text";
    fileNameInput.setAttribute("readonly","readonly");
	fileDiv.appendChild(fileNameInput);
	var button = document.createElement("button");
	button.innerHTML = "Open File";
    ...
    fileInput.type = "file";
    fileInput.id = "taskFileXml";
    fileInput.name = "taskXml";
    form.appendChild(fileInput);
    var inputTextarea = document.createElement("textarea");
    inputTextarea.style.width = "99%";
    inputTextarea.style.height = "347px";
    inputTextarea.style.overflowY = "auto";
    inputTextarea.style.resize = "none";
    inputTextarea.style.border = "none";
    inputTextarea.style.borderTop = "1px solid #ccc";
    inputTextarea.value = geoIcon.outerHTML;

	Con2.appendChild(inputTextarea);

    this.init = function()
    {
        $(document).off("click",".tabList li");
        $(document).on("click",".tabList li",function () {
            $(".tabList li").removeClass("cur");
            $(this).addClass("cur");
            $(".tabCon >div").removeClass("cur");
            $(".tabCon >div").eq($(this).index()).addClass("cur");
        });
        firstPage = true;
        $.ajax({
			url:"/GeoModelingNew/IconTaskServlet",
			type:"get",
			data:{"page":1},
			success:function (result) {
				var info = JSON.parse(result);
                if(info.count===0){
                    $("#taskList").empty();
                    if(language==="en"){
                        $("#taskList").append("<p>you don't have task</p>");
                    }else {
                        $("#taskList").append("<p>没有属于你的图标计划</p>");
                    }
                    $("#TaskPage").empty();
                }else {
                    $("#TaskPage").initPage(info.count,1,regetTask);
                    createTaskTable(info.task,"taskList");
                }
            }
		});

        $(document).off("click","#taskList .taskli");
        $(document).on("click","#taskList .taskli",function(){
        ...
        $("#taskFileXml").change(function () {
            ...
            if(type.indexOf("xml")>=0){
               ...
               $.ajax({
                   url: "/GeoModelingNew/LoadTaskXmlServlet",
                   type: "POST",
                   data: formData,
                   async: false,
                   success: function (msg) {
                      	inputTextarea.value = msg;
            	...
            	alert("please select a correct xml file");
			}
        });
    };
    ...
    {
        // Removes all illegal control characters before parsing
		var index= $(".tabList li.cur").index();
        editorUi.sidebar.clearIconList();
		if(index===0){
			var xml = textarea.value;
            editorUi.sidebar.loadIconFromTask(xml,true);
		}else{
			var xml = inputTextarea.value;
            editorUi.sidebar.loadIconFromTask(xml,true);
		}
 ...
 * Constructs a new edit file dialog.
 */
var LoadConceptualModelDialog = function (editorUi) {
    var div = document.createElement("div");
    div.style.textAlign = "right";
    var tabList  = document.createElement("div");
    tabList.className = "tabList";
    ...
    var curli = document.createElement("li");
    curli.className = "cur";
    curli.innerHTML = "Online Model";
    var li  = document.createElement("li");
    li.innerHTML = "Upload Model";
    ul.appendChild(curli);
    ul.appendChild(li);
    tabList.appendChild(ul);
    ...
    textarea.value = GraphXml.outerHTML;
    Con1ChildDiv.appendChild(textarea);
    ...
    var fileInput = document.createElement("input");
    fileInput.type = "file";
    fileInput.id = "conceptualFileXml";
    fileInput.name = "conceptualXml";
    form.appendChild(fileInput);
    var inputTextarea = document.createElement("textarea");
    inputTextarea.style.width = "99%";
    inputTextarea.style.height = "347px";
    ...
    inputTextarea.style.border = "none";
    inputTextarea.style.borderTop = "1px solid #ccc";
    inputTextarea.value = GraphXml.outerHTML;
    ...
    this.init = function()
    {
        ...
        firstPage = true;
        $.ajax({
            url:"/GeoModelingNew/ConceptualModelEditorServlet",
            type:"get",
            data:{"page":1},
            success:function (result) {
                var info = JSON.parse(result);
                if(info.count===0){
                    $("#conceptualList").empty();
                    if(language==="en"){
                        $("#conceptualList").append("<p>you don't have conceptual model</p>");
                    }else {
                        $("#conceptualList").append("<p>没有属于你的概念模型</p>");
                    }
                    $("#ConceptualPage").empty();
                }else {
                    $("#ConceptualPage").initPage(info.count,1,regetConceptualModel);
                    createConceptualModelTable(info.conceptual,"conceptualList");
                }
            }
        });
        $(document).off("click","#conceptualList .conceptualli");
        $(document).on("click","#conceptualList .conceptualli",function(){
            var xml = $(this).attr("xml");
            textarea.value = xml;
            uid = $(this)[0].id;
        });
        ...
        button.onclick = function () {
            $("#conceptualFileXml").click();
        }

        $("#conceptualFileXml").change(function () {
            var file = this.files[0];
            var name = file.name;
            if(name===undefined){
                fileNameInput.value = "";
            ...
            var type = file.type;
            if(type.indexOf("xml")>=0){
                var formData = new FormData($('#conceptualForm')[0]);
                $.ajax({
                    url: "/GeoModelingNew/LoadConceptualModelXmlServlet",
                    type: "POST",
                    data: formData,
                    async: false,
                    success: function (msg) {
    ...
    var okBtn = mxUtils.button(mxResources.get('ok'), function()
    {
        ...
        var error = null;
        if(index===0){
        	$(".geDiagramContainer").attr("uid",uid);
			var xml = textarea.value;
            editorUi.editor.graph.model.beginUpdate();
            try
            {
                var xml_doc = mxUtils.parseXml(xml);
                xml_doc.documentElement.setAttribute("page",0);
                if (editMode==false){
                    xml_doc.documentElement.setAttribute("page",0);
                }
                editorUi.editor.setGraphXml(xml_doc.documentElement);
 ...
 * Constructs a new edit file dialog.
 */
var ConfirmSaveTaskDialog = function (editorUi) {
	var div = document.createElement("div");
	div.style.textAlign = "center";
	var p = document.createElement("p");
	p.innerHTML = "Are you sure to save the task?";
    div.appendChild(p);
	var input = document.createElement("input");
    ...
    {
        // Removes all illegal control characters before parsing
        var task = editorUi.sidebar.getAllLoadedIcon();
        $.ajax({
			url:"/GeoModelingNew/IconTaskServlet",
			type:"post",
			data:{"name":input.value,"task":task.outerHTML},
			success:function (result) {
				alert(result);
            }
		})
 ...
 * Constructs a new edit file dialog.
 */
var ConfirmSaveConceptualModelDialog = function (editorUi) {
    var div = document.createElement("div");
    div.style.textAlign = "center";
    var p = document.createElement("p");
    p.innerHTML = "Are you sure to save the Conceptual Model?";
    div.appendChild(p);
 ...
 */
var EditRelatedModel = function(editorUi, cell, callback)
{
	var div = document.createElement('div');
	var graph = editorUi.editor.graph;
	...
	var relateModelDiv = document.createElement("div");
	relateModelDiv.style.width = "100%";
	relateModelDiv.style.height = "50px";
	relateModelDiv.style.overflowY = "auto";
	relateModelDiv.style.border = "1px solid #ccc";
	div.appendChild(relateModelDiv);

	var lis = $("#model_col li");
	for(var i=0;i<lis.length;i++){
		var tagText = lis.eq(i).text();
		var tagId =lis.eq(i)[0].id;
        var tagDiv = document.createElement("div");
        tagDiv.className = "ItemTag";
        tagDiv.style.float = "left";
        tagDiv.style.padding = "0px 5px 0px 5px";
        tagDiv.style.margin = "1px 2px 0px 2px";
        var tagSpan = document.createElement("span");
        tagSpan.innerHTML = tagText;
        tagSpan.style.paddingRight ="3px";
        tagDiv.appendChild(tagSpan);
        var tagI = document.createElement("i");
        tagI.className = "glyphicon glyphicon-remove";
        tagI.onclick = function () {
            $(tagDiv).remove();
        };
        tagDiv.appendChild(tagI);
        tagDiv.setAttribute("name",tagText);
        tagDiv.setAttribute("uid",tagId);
        relateModelDiv.appendChild(tagDiv);
	}


	var modelDiv = document.createElement("div");
	modelDiv.style.display = "inline-flex";
	modelDiv.style.width = "100%";
    modelDiv.style.border = "1px solid #ccc";
    modelDiv.style.marginTop = "5px";
    div.appendChild(modelDiv);

    var modelTree = document.createElement("div");
    modelTree.id = "modelItemTree";
    modelTree.className = "tree";
    modelTree.style.width = "35%";
    modelTree.style.height = "350px";
    modelTree.style.maxHeight = "350px";
    modelTree.style.overflow = "hidden";
    modelTree.style.borderRight = "1px solid #ccc";
    modelTree.onmouseover = function () {
        modelTree.style.overflow = "auto";
    };
    modelTree.onmouseout = function () {
        modelTree.style.overflow = "hidden";
    };
    modelDiv.appendChild(modelTree);

    var modelInfoPanel = document.createElement("div");
    modelInfoPanel.style.width = "64%";
    modelInfoPanel.style.marginLeft = "1%";
    modelInfoPanel.style.height = "350px";
    /*modelInfoPanel.style.maxHeight = "350px";*/
	modelDiv.appendChild(modelInfoPanel);

	var searchDiv = document.createElement("div");
    searchDiv.style.display = "inline-flex";
    searchDiv.style.width = "100%";
    modelInfoPanel.appendChild(searchDiv);
    var searchInput = document.createElement("input");
    searchInput.id = "searchMItemInput";
    searchInput.style.width = "90%";
    searchDiv.appendChild(searchInput);
    var searchBtn = document.createElement("button");
    searchBtn.id = "searchMItemBtn";
    searchBtn.style.borderRadius = "0px";
    searchDiv.appendChild(searchBtn);
    var i = document.createElement("i");
    i.className = "glyphicon glyphicon-search";
    searchBtn.appendChild(i);

    var modelInfoTable  = document.createElement("div");
    modelInfoTable.id = "modelInfoTable";
    modelInfoTable.style.height = "318px";
    modelInfoTable.style.maxHeight = "318px";
    modelInfoTable.style.marginTop ="2px";
    modelInfoTable.style.overflowY = "auto";
    modelInfoTable.style.overflowX = "hidden";
    modelInfoPanel.appendChild(modelInfoTable);
    ...
    this.init = function(){
		$.ajax({
            url:"/GeoModelingNew/ModelRepositoryServlet",
            type:"get",
            success:function(data){
                var result = data;
                ...
                $('#modelItemTree').treeview({
                    data: tree
                });

                $('#modelItemTree').on('nodeSelected', function (event, data) {
                    console.log(event);
                    console.log(data);
                    if (data.nodes === undefined) {
                        firstPage = true;
                        $.ajax({
                            url:"/GeoModelingNew/ModelItemsServlet",
                            type:"get",
                            async:false,
                            data:{"uid":data.id,"page":"1","sortType":"name","asc":1},
                            success:function(data){
                                var result = JSON.parse(data);

                                if(result.count===0){
                                    $("#modelInfoTable").empty();
                                    if(language==="en"){
                                        $("#modelInfoTable").append("<p>There is no model item in this classification</p>");
                                    }else {
                                        $("#modelInfoTable").append("<p>该分类下没有模型条目</p>");
                                    }
                                    $("#ModelItemPage").empty();
                                }else {
                                    $("#ModelItemPage").initPage(result.count,1,regetModelItems);
                ...
                $.ajax({
                    ...
                    type:"get",
                    async:false,
                    data:{"uid":modelItemClassId,"page":"1","sortType":"name","asc":1},
                    success:function(data){
                        var result = JSON.parse(data);
        ...
        $(document).off("click","#modelItemTree li a");
		$(document).on("click","#modelItemTree li a",function(){
			firstPage = true;
            var nameId=$(this).attr('uid');
            if(nameId==modelItemClassId){
                return;
            }else{
                modelItemClassId=nameId;
            }
            $.ajax({
                url:"/GeoModelingNew/ModelItemsServlet",
                type:"get",
		...
		searchBtn.onclick = function () {
            ...
            if(searchName===""){
                ...
                searchFlag = true;
                $.ajax({
                    url:"/GeoModelingNew/SearchModelItemsServlet",
                    type:"get",
                    async:false,
                    data:{"searchText":searchName,"uid":modelItemClassId,"page":"1","sortType":"name","asc":1},
                    success:function (data) {
                        var result = JSON.parse(data);
        ...
        $(document).off("click","#modelInfoTable tbody td");
        $(document).on("click","#modelInfoTable tbody td",function () {
        	var selectedItems = relateModelDiv.childNodes;
			for(var i=0;i<selectedItems.length;i++){
				if(selectedItems[i].getAttribute("uid")===$(this)[0].id){
					alert("the model item has been selected");
					return false;
				}
			}
			var tagDiv = document.createElement("div");
			...
			tagDiv.appendChild(tagI);
			tagDiv.setAttribute("name",$(this).text());
			tagDiv.setAttribute("uid",$(this)[0].id);
            relateModelDiv.appendChild(tagDiv);
        });
	};
	...
	var okBtn = mxUtils.button(mxResources.get('ok'), function()
	{
        ...
        for(var i=0;i<selectedItems.length;i++){
			var item = {};
			item.uid = selectedItems[i].getAttribute("uid");
			item.name = selectedItems[i].getAttribute("name");
			items.push(item);
		}
        relateModelDiv.innerHTML ="";
		...
		try
		{
			...
			//TODO
			//在此加上选择模型/概念之后的逻辑
            value.setAttribute('relate_models',JSON.stringify(items));
 ...
 * Optional help link.
 */
EditRelatedModel.placeholderHelpLink = null;

/**
 * Constructs a new metadata dialog.
 */
var EditRelatedConcept = function(editorUi, cell, callback)
{
    var div = document.createElement('div');
    var graph = editorUi.editor.graph;
    ...
    relateConceptDiv.style.width = "100%";
    relateConceptDiv.style.height = "50px";
    relateConceptDiv.style.overflowY = "auto";
    relateConceptDiv.style.border = "1px solid #ccc";
    div.appendChild(relateConceptDiv);

    var lis = $("#concept_col li");
    for(var i=0;i<lis.length;i++){
        var tagText = lis.eq(i).text();
        var tagId =lis.eq(i)[0].id;
        var tagDiv = document.createElement("div");
        ...
        tagDiv.setAttribute("name",tagText);
        tagDiv.setAttribute("uid",tagId);
        relateConceptDiv.appendChild(tagDiv);
    }


    var conceptDiv = document.createElement("div");
    conceptDiv.style.display = "inline-flex";
    conceptDiv.style.width = "100%";
    conceptDiv.style.border = "1px solid #ccc";
    conceptDiv.style.marginTop = "5px";
    div.appendChild(conceptDiv);

    var conceptTree = document.createElement("div");
    conceptTree.id = "conceptTree";
    conceptTree.className = "tree";
    conceptTree.style.width = "35%";
    conceptTree.style.height = "350px";
    conceptTree.style.maxHeight = "350px";
    conceptTree.style.overflow = "hidden";
    conceptTree.style.borderRight = "1px solid #ccc";
    conceptTree.onmouseover = function () {
        conceptTree.style.overflow = "auto";
    };
    conceptTree.onmouseout = function () {
        conceptTree.style.overflow = "hidden";
    };
    conceptDiv.appendChild(conceptTree);

    var conceptInfoPanel = document.createElement("div");
    conceptInfoPanel.style.width = "64%";
    conceptInfoPanel.style.marginLeft = "1%";
    conceptInfoPanel.style.height = "350px";
    /*conceptInfoPanel.style.maxHeight = "350px";*/
    conceptDiv.appendChild(conceptInfoPanel);

    var searchDiv = document.createElement("div");
    searchDiv.style.display = "inline-flex";
    searchDiv.style.width = "100%";
    conceptInfoPanel.appendChild(searchDiv);
    var searchInput = document.createElement("input");
    searchInput.id = "searchConceptInput";
    searchInput.style.width = "90%";
    searchDiv.appendChild(searchInput);
    var searchBtn = document.createElement("button");
    searchBtn.id = "searchConceptBtn";
    searchBtn.style.borderRadius = "0px";
    searchDiv.appendChild(searchBtn);
    var i = document.createElement("i");
    i.className = "glyphicon glyphicon-search";
    ...
    var conceptInfoTable  = document.createElement("div");
    conceptInfoTable.id = "conceptInfoTable";
    conceptInfoTable.style.height = "318px";
    conceptInfoTable.style.maxHeight = "318px";
    conceptInfoTable.style.marginTop ="2px";
    conceptInfoTable.style.overflowY = "auto";
    conceptInfoTable.style.overflowX = "hidden";
    conceptInfoPanel.appendChild(conceptInfoTable);
    ...
    this.init = function(){
        $.ajax({
            url:"../../ConceptRelationServlet",
            type:"get",
            success:function(tree){
                $('#conceptTree').empty();
                $('#conceptTree').append(tree);
                resetTree();
                firstPage = true;
                $.ajax({
                    url:"../../conceptServlet",
                    type:"get",
                    async:false,
                    data:{"uid":conceptClassId,"page":"1","sortType":"name"},
                    success:function(data){
                        var result = JSON.parse(data);
                        if(result.count===0){
                            $("#conceptInfoTable").empty();
                            if(language==="en"){
                                $("#conceptInfoTable").append("<p>There is no semantic/concept in this classification</p>");
                            }else {
                                $("#conceptInfoTable").append("<p>该分类下没有概念</p>");
                            }
                            $("#ConceptPage").empty();
                        }else {
                            $("#ConceptPage").initPage(result.count,1,regetConcept);
        ...
        $(document).off("click","#conceptTree li a");
        $(document).on("click","#conceptTree li a",function(){
            firstPage = true;
            var nameId=$(this).attr('uid');
            if(nameId==conceptClassId){
                return;
            }else{
                conceptClassId=nameId;
            }
            $.ajax({
                url:"../../conceptServlet",
                type:"get",
        ...
        searchBtn.onclick = function () {
            ...
            if(searchName===""){
                ...
                $.ajax({
                    ...
                    type:"get",
                    async:false,
                    data:{"searchText":searchName,"uid":conceptClassId,"page":"1","sortType":"name"},
                    success:function (data) {
                        var result = JSON.parse(data);
                        arrayModels = result.conceptModels;
                        if(result.count===0){
                            $("#conceptInfoTable").empty();
                            if(language==="en"){
                                $("#conceptInfoTable").append("<p>There is no semantic/concept in this classification</p>");
        ...
        $(document).off("click","#conceptInfoTable tbody td");
        $(document).on("click","#conceptInfoTable tbody td",function () {
            var selectedConcept = relateConceptDiv.childNodes;
            for(var i=0;i<selectedConcept.length;i++){
                if(selectedConcept[i].getAttribute("uid")===$(this)[0].id){
                    alert("the semantic/concept has been selected");
                    return false;
                }
            }
            var tagDiv = document.createElement("div");
	...
	var okBtn = mxUtils.button(mxResources.get('ok'), function()
	{
		...
		try
		{
            ...
            for(var i=0;i<selectedConcept.length;i++){
                var item = {};
                item.uid = selectedConcept[i].getAttribute("uid");
                item.name = selectedConcept[i].getAttribute("name");
                concept.push(item);
            }
            relateConceptDiv.innerHTML ="";

            value.setAttribute('relate_concepts',JSON.stringify(concept));
 ...
 * Optional help link.
 */
EditRelatedConcept.placeholderHelpLink = null;
