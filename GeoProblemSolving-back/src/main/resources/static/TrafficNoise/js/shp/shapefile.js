...
function open(shp$$1, dbf$$1, options) {
  ...
  if (typeof shp$$1 === "string") {
    ...
    if (dbf$$1 === undefined) dbf$$1 = path(shp$$1.substring(0, shp$$1.length - 4) + ".mdbf", options).catch(function() {});
...
function openDbf(source, options) {
  ...
  if (typeof source === "string") {
    if (!/\.mdbf$/.test(source)) source += ".mdbf";
    source = path(source, options);
  } else if (source instanceof ArrayBuffer || source instanceof Uint8Array) {
    source = array(source);
  } else {
